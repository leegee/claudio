...
var authString = function authString(accessToken) {
...
izel.pageMenuAfterRender = function () {
    ...
    this.updateStatus = this.updateStatus || function () {
        fetch(Config.endpoints.local + '?action=status;' + authString(this.state.access_token)).then(function (res) {
            return res.json();
        }).then(function (json) {
            console.table(json);
            try {
...
izel.pageSelectAugmentDbAfterRender = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var _this2 = this;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    document.getElementById('skusCsvAugment').addEventListener('change', function (e) {
                        _this2.state.file = e.target.files[0];
                        _this2.nextPage('augment-db');
                    }, false);
...
izel.pageSelectSkusAfterRender = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var _this3 = this;
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
            switch (_context3.prev = _context3.next) {
                case 0:
                    document.getElementById('skusCsv').addEventListener('change', function (e) {
                        _this3.state.file = e.target.files[0];
                        _this3.nextPage('preview-upload');
                    }, false);
...
izel.pageWipeGoogleDataAfterRender = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
...
izel.pageMapSomeSkusBeforeRender = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
...
izel.pageMapSomeSkusAfterRender = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
                ...
                switch (_context7.prev = _context7.next) {
                    case 0:
                        return _context7.abrupt('return', new Promise(function (resolve, reject) {
                            ...
                            request.open('POST', Config.endpoints.local + '?' + authString(_this4.state.access_token));
                            request.send(data);
                        }));
...
izel.pagePreviewDbBeforeRender = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
    var response, json;
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
            switch (_context8.prev = _context8.next) {
                case 0:
                    _context8.next = 2;
                    return window.fetch(Config.endpoints.local + '?action=preview-db');
...
izel.setCssClass = function (internalTableId, isPublished) {
    ...
    var str = 'FT_' + internalTableId + '::before { content: "' + (internalTableId === 0 ? '☑' : '☐') + '"}';
    style.sheet.insertRule(str, 0);
};

izel.pagePreviewDbAfterRender = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
    var todo, el;
        ...
        while (1) {
            switch (_context9.prev = _context9.next) {
                case 0:
                    ...
                    if (!todo) {
                        el = document.getElementById('publish-tableInternalId2googleTableId');
...
var Handlebars = __webpack_require__(335);
 ...
 *
 */
var Wizard = function Wizard(state) {
    var _this = this;
    ...
    this.hide('spinner');
    this.el.ctrlMenu.addEventListener('click', function () {
        _this.nextPage('menu');
    });
...
Wizard.prototype.nextPage = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(pageName) {
        for (var _len2 = arguments.length, passOnArgs = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
            passOnArgs[_key2 - 1] = arguments[_key2];
        }
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 3;
                        return this._execute('page-' + this.state.pageName + '-on-leave', passOnArgs);
                    ...
                    case 8:
                        ...
                        _context.next = 13;
                        return this._execute(fnNames, passOnArgs);
                    ...
                    case 13:
                        ...
                        _context.next = 18;
                        return this._execute('page-' + this.state.pageName + '-after-render', passOnArgs);
...
Wizard.prototype._execute = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(fns, passOnArgs) {
        var $name, promises, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, f, fn;
...
Handlebars.registerHelper('wizardIncludeTemplate', function (templateId) {
    var html = Handlebars.compile(document.getElementById(templateId).innerHTML.toString())({ wizard: this.wizard });
...
Wizard.prototype.render = function () {
    ...
    try {
        // No caching:
        this.el.main.innerHTML = Handlebars.compile(this.pageEl.innerHTML.toString())({ wizard: this });
        window.scrollTo(0, 0);
                            ...
                            while (1) {
                                switch (_context3.prev = _context3.next) {
                                    case 0:
                                        _this2.show('spinner');
                                        _context3.next = 3;
                                        return _this2.nextPage(e.target.dataset.gotoPage, e);
...
Wizard.prototype._antsToCamelCase = function (str) {
    return str.replace(/-(\w)/g, function (_, initial) {
...
var handlebars = __webpack_require__(336)['default'];

var printer = __webpack_require__(358);
...
var _handlebarsRuntime = __webpack_require__(337);

var _handlebarsRuntime2 = _interopRequireDefault(_handlebarsRuntime);

// Compiler imports

var _handlebarsCompilerAst = __webpack_require__(129);

var _handlebarsCompilerAst2 = _interopRequireDefault(_handlebarsCompilerAst);

var _handlebarsCompilerBase = __webpack_require__(351);

var _handlebarsCompilerCompiler = __webpack_require__(355);

var _handlebarsCompilerJavascriptCompiler = __webpack_require__(356);

var _handlebarsCompilerJavascriptCompiler2 = _interopRequireDefault(_handlebarsCompilerJavascriptCompiler);

var _handlebarsCompilerVisitor = __webpack_require__(93);
...
var _handlebarsSafeString = __webpack_require__(349);
...
var _handlebarsRuntime = __webpack_require__(350);
...
var _helpersBlockHelperMissing = __webpack_require__(339);

var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);

var _helpersEach = __webpack_require__(340);

var _helpersEach2 = _interopRequireDefault(_helpersEach);

var _helpersHelperMissing = __webpack_require__(341);

var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);

var _helpersIf = __webpack_require__(342);

var _helpersIf2 = _interopRequireDefault(_helpersIf);

var _helpersLog = __webpack_require__(343);

var _helpersLog2 = _interopRequireDefault(_helpersLog);

var _helpersLookup = __webpack_require__(344);

var _helpersLookup2 = _interopRequireDefault(_helpersLookup);

var _helpersWith = __webpack_require__(345);
...
var _decoratorsInline = __webpack_require__(347);
...
var _parser = __webpack_require__(352);

var _parser2 = _interopRequireDefault(_parser);

var _whitespaceControl = __webpack_require__(353);
...
var _ast = __webpack_require__(129);
...
var _codeGen = __webpack_require__(357);
